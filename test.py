...
def test(images, model, is_reversed, size, context):
    ...
    for path in images:
        ...
        fake_a_y = dis_a(fake)
        fake_b_y = dis_b(fake)
        print("Real score A:", mx.nd.sigmoid(real_a_y)[0].asscalar())
        print("Real score B:", mx.nd.sigmoid(real_b_y)[0].asscalar())
        print("Fake score A:", mx.nd.sigmoid(fake_a_y)[0].asscalar())
        print("Fake score B:", mx.nd.sigmoid(fake_b_y)[0].asscalar())
        plt.subplot(1, 3, 1)
